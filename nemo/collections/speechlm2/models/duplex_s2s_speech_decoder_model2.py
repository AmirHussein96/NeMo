...
class DuplexS2SSpeechDecoderModel2(LightningModule, HFHubMixin):
    def __init__(self, cfg: dict) -> None:
        ...
        self._codebook_size = getattr(
            self.audio_codec.vector_quantizer,
            'codebook_size_per_group',
            getattr(self.audio_codec.vector_quantizer, 'codebook_dim_per_group', None)
        )
    ...
    def offline_inference(
        ...
        T_config = self.cfg.get("inference_tgt_len", 1.5 * T_tensor.item())
        T = int(T_config)
