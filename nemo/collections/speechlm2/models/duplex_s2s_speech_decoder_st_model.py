...
class DuplexS2SSpeechDecoderModelST(LightningModule, HFHubMixin):
    ...
    def prepare_inputs(self, batch: dict):
        ...
        speech_mask = torch.zeros_like(target_tokens, dtype=torch.bool)
        ...
        for i in range(bsz):
            ...
            for j in range(len(turn_start_pos)):
                text_mask[i, turn_start_pos[j] : turn_end_pos[j]+1] = True
        ...
        del source_encoded, source_encoded_lens
        ...
        del target_codes, target_codes_lens
